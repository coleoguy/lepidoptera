...
# load results
load("../results/5a.false.positive.test.Lepidoptera.rate.analysis.feeding.fix.incomplete.RData")
results <- x
...
# read in data from thhe initial MCMC
dat <- read.csv("../results/5a.false.positive.test.Lepidoptera.rate.analysis.feeding.csv")
dat <- rbind(dat, post.burnin.inc)
...
# save results
write.csv(x = dat,
          file = "../results/5a.false.positive.test.Lepidoptera.rate.analysis.feeding.proc.csv",
          row.names = F)
