...
# make results place holder
final.results <- vector(mode = "list", length = iter)
# set repeating trees
treeRep <- rep(1:10, each = 10)
# run the loop
for(l in 1:100){
        # set k
        k <- treeRep[l]
        ...
        # store final results
        final.results[[l]] <- MCMC.dat
}

save.image("../results/7a.Lepidoptera.branch.specific.rates.RData")
