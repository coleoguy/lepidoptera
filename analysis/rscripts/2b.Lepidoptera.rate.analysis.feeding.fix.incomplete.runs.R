...
x <- foreach(j = 93, .verbose = T, .packages = c("ape","maps","diversitree", "phytools", "chromePlus")) %dopar% {
...
stopCluster(cl)
# save
save.image("../results/2.Lepidoptera.rate.analysis.feeding.fix.incomplete.runs.RData")
