        ...
        for(iiii in 1:100){
          ...
          empP <- getEmpiricalPMC(tree = trees[[ii]][[iiii]],
                                  ...
                                  args.MCMC = list(iter.temp = 20,
                                                   ...
                                                   print.every=100))
          if(dir.exists(paste("../results/empP-MCMC-all-trees/",rep,"/tree",iiii, sep=".")) == F){
            dir.create(paste("../results/empP-MCMC-all-trees/",rep,"/tree",iiii, sep="."),recursive = T)  
          }
          save(empP, file = paste("../results/empP-MCMC-all-trees/rep",
                                  rep,
                                  "/tree.",
                                  iiii,
                                  "/empP",
